...
export class ContactEditComponent implements OnInit {
    ...
    constructor(
        contactSerice: ContactService,
        routerParams: RouteParams
    ) {
        this._contactService = contactSerice;
        this._routerParams = routerParams;
    }

    ngOnInit() {
        const id: string = this._routerParams.get('id');
    ...
    onSubmit(event) {
        ...
        this._contactService.update(this.contact).subscribe((contact) => {
            this.contact = contact;
