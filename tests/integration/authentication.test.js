...
describe('Authentification test', () => {
    ...
    describe('Sign in user', () => {
        it('should sign in a user with valid credefntials', (done) => {
            request({
                method: 'POST',
        ...
        it('should not sing in a user with invalid credentials', (done) => {
            request({
                mehotd: 'POST',
                url: baseUrl + '/auth/signin',
                form: {
                ...
                json: true
                    ...
                    body.message.should.equal('Invalid email o password.');
                    done();
            });
        });
    });
